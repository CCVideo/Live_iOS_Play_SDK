...
- (void) handlePan:(UIPanGestureRecognizer*) recognizer
{
    ...
    switch (recognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
        {
            ...
            CGFloat x = smallVideoRect.origin.x < view.frame.origin.x ? 0 : smallVideoRect.origin.x;
            
            CGFloat y = smallVideoRect.origin.y < view.frame.origin.y ? 0 : smallVideoRect.origin.y;
            
            x = (x + smallVideoRect.size.width) > (view.frame.origin.x + view.frame.size.width) ? (view.frame.origin.x + view.frame.size.width - smallVideoRect.size.width) : x;
            
            y = (y + smallVideoRect.size.height) > (view.frame.origin.y + view.frame.size.height) ? (view.frame.origin.y + view.frame.size.height - smallVideoRect.size.height) : y;
