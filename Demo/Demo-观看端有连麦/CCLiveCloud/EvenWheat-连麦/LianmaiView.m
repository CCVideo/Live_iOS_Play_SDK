...
-(void)initUIWithVideoPermission:(AVAuthorizationStatus)videoPermission AudioPermission:(AVAuthorizationStatus)audioPermission {
    ...
    [_bgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(ws).offset(-CCGetRealFromPt(15));
    ...
    [_cornerImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(ws.bgView.mas_right).offset(-CCGetRealFromPt(2));
    ...
    if(videoPermission == AVAuthorizationStatusAuthorized && audioPermission == AVAuthorizationStatusAuthorized) {
        ...
        [self createImageWithImgName:@"videoType" andTitle:@"视频连麦" withBtn:_videoBtn];
        ...
        [self createImageWithImgName:@"lianmai_voice" andTitle:@"语音连麦" withBtn:_audioBtn];
...
//    if(self.isVideo) {
//        self.msgLabel.text = @"视频连麦申请中...";
//    } else {
//        self.msgLabel.text = @"音频连麦申请中...";
//    }
}
