...
//
    ...
    btn.frame = CGRectMake(0, IS_IPHONE_X ? 93: 53, 100, 40);
    [btn addTarget:self action:@selector(changedoc:) forControlEvents:UIControlEventTouchUpInside];
    [btn setTitle:@"拉伸填充" forState:UIControlStateNormal];
    UIButton *btn1 = [[UIButton alloc] init];
    [btn1 setBackgroundColor:[UIColor greenColor]];
    [self.view addSubview:btn1];
    btn1.frame = CGRectMake(100, IS_IPHONE_X ? 93: 53, 100, 40);
    [btn1 setTitle:@"等比居中" forState:UIControlStateNormal];
    ...
    btn3.frame = CGRectMake(200, IS_IPHONE_X ? 93: 53, 100, 40);
...
- (void)changedoc:(UIButton *)sender {
    ...
    _pptScaleMode = 1;
    [_offlinePlayBack changeDocPPTScalingMode:_pptScaleMode];
}
...
- (void)integrationSDK {
    ...
    parameter.PPTScalingMode = 4;//ppt展示模式,建议值为2
