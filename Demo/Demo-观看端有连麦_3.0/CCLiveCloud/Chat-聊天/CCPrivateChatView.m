...
-(UIButton *)closeButton {
    if(!_closeButton) {
        ...
        [_closeButton setImage:[UIImage imageNamed:@"弹窗关闭"] forState:UIControlStateNormal];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIImageView *headImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"主持"]];
    ...
    UIImageView *idot = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"头像新消息"]];
